var VanillaScrollspy = function() {
  ...
  class e {
    ...
    scrollToY(e = 0) {
      ...
      const n = e,
        ...
        c = () => {
          ...
          const e = t / s,
            r = i[this.easing](e);
          if (e < 1) return window.requestAnimationFrame(c), void window.scrollTo(0, o + (n - o) * r);
          window.scrollTo(0, n)
        };
      c()
    }
    ...
    init() {
      this.animated(), document.addEventListener("scroll", (() => this.menuControl()))
    }
  }
  return function(...t) {
    return new e(...t)
